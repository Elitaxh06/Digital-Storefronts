...
function EditBusiness() {
    ...
    return (
        <section className="mt-24">
            {/* <Dashboard /> */}
            {/* <Link to="/dashboard" className="text-blue-500 border-b border-blue-600 hover:text-blue-700">Volver</Link> */}
            ...
            >
              <div
                className="bg-green-400 rounded-xl h-10 w-1/4 flex items-center justify-center absolute left-1 top-[4px] group-hover:w-[138px] z-10 duration-500"
              >
                <svg
