            ...
            <div className="mt-22">
                {negocios?.datos && esNegocio(negocios.datos) ? (
                    <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1  mx-2 my-4 rounded-lg">
                        {negocios.datos.activos.map((negocio: Negocios) => (
                            <div key={negocio.id} className="bg-white shadow-md p-4 flex flex-col h-full mx-2 my-4 rounded-lg hover:-translate-y-2  transition-transform duration-200 hover:text-orange-500">
                                    <div className="flex flex-col justify-center ">
                                        ...
                                        <button className="bg-orange-500 hover:bg-orange-600 cursor-pointer text-white h-10 rounded-lg font-semibold mt-auto" onClick={() => setShowModal(negocio)}>Ver mas detalles</button>
                                </div>
                            </div>
                    ...
                    <>
                        ...
                        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-6 rounded-lg shadow-lg z-50  w-[70%] max-h-[90vh] overflow-y-auto">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <p>Categoria: {showModal.nombre_categoria}</p>
                            </div>
                            <div className="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 mt-2">
                                ...
                                <div className="flex flex-col items-center">
                                    <h4 className="text-md font-bold mt-1 text-center ">Descripcion</h4>
