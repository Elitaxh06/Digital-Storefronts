...
function Login(){
    ...
    return(
        <section className="mt-24 mb-18 px-4">
            <h3 className="text-center font-bold text-3xl">Inicio de Sesión</h3>
            ...
            <div className="relative z-0 w-full mb-5 group">
                <input 
                    ...
                    placeholder=" " name="floating_email" 
                    id="floating_email" 
                    className="block py-2.5 px-0 w-full text-base text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" 
            ...
            <p className="mt-2">¿Olvidaste tu contraseña?
                <Link to="/reset-password" className="text-blue-500 border-b border-blue-600 hover:text-blue-700"> Cambiar Contraseña</Link>
            </p>
            </form>
        </section>
    )
